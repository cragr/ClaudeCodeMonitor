...
2. Open the DMG and drag `ClaudeCodeMonitor.app` to your Applications folder

3. Launch the app from Applications (first launch: right-click → Open to bypass Gatekeeper)
